...
export class CardapioListPage {
  ...
  initializeItems() {
    ...
    this.produto = [
      ...
      { id: 4, nome: "Agua", url: "http://www.flaska.com.br/documents/flaska.com.br/large/396.jpg", valor: 10, tipo: 2, descricao: descricaoPadrao, adicionais: []},
      { id: 5, nome: "Refrigerante", url: "http://midias.gazetaonline.com.br/_midias/jpg/2017/06/20/refrigerante-5158046.jpg", valor: 10, tipo: 2, descricao: descricaoPadrao, adicionais: []},
      { id: 6, nome: "Suco de laranja", url: "http://www.xando.com.br/images/itens/itemCopo.jpg", valor: 10, tipo: 2, descricao: descricaoPadrao, adicionais: []},
